...
var queryChaincode = function(peer, channelName, chaincodeName, args, fcn, username, org, errMsgJson) {
    ...
    return helper.getUserClientAndChannel(username, org, true)
    .then((obj) => {
...
var getChannels = function(peer, username, org) {
    ...
    return helper.getUserClient(username, org, true)
    .then((client) => {
...
/********************************  Invoke  ***********************************************/
/*****************************************************************************************/
var invokeChaincode = function(peerNames, channelName, chaincodeName, fcn, args, username, org, errMsgJson, eventHubTimeout) {
